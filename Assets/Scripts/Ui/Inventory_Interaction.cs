...
public class Inventory_Interaction : MonoBehaviour
{
    ...
    private List<RaycastResult> hitObjects = new List<RaycastResult>(); //saves all of the raycast results under the mouse
    ...
    void Update()
    {
        ...
        print("So whats the child index " + iDisplay.gameObject.transform.GetSiblingIndex());
