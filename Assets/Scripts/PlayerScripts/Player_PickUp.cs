...
public class Player_PickUp : MonoBehaviour
{
    ...
    public Player_Attributes pAttributes;
    ...
    public void PickedUp(Item_Component item) //every pick up system calls this to decide what to do with it and destroy it
    {
